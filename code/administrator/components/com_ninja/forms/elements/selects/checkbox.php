...
/**
 * @version		$Id: checkbox.php 552 2010-10-28 19:41:51Z stian $
 * @category	Koowa
 * @package		Koowa_Form
 * @subpackage 	Element
 ...
 * @subpackage 	Element
 */
class ComNinjaFormElementSelectCheckbox extends ComNinjaFormElementAbstract
{
	/**
	 ...
	 */
	protected $_validAttribs = array('disabled', 'value', 'accesskey', 'class', 'dir', 'id', 'lang', 'style', 'tabindex', 'title', 'xml:lang');
