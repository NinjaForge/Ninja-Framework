...
/**
 * @version		$Id: access.php 980 2011-04-04 20:26:19Z stian $
 * @package		Ninja
 ...
 * @uses		KArrayHelper
 */
class ComNinjaHelperAccess extends KTemplateHelperAbstract
{
	...
	public function __construct(KConfig $options)
	{
		...
		$this->set($options->append(array(
			'name'	 => $name,
			'models' => (object) array(
				'assets' 		=> $app.'::com.'.$package.'.model.assets',
				'user_groups'	=> $app.'::com.'.$package.'.model.user_groups'
			),
			'inputName' => 'access',
			'inputId'   => 'access',
			'id'	    => 'access',
	...
	{
		$rules = KFactory::tmp($this->models->assets)->limit(0)->name($this->name)->getList();
	...
	public function permissionslist()
	{
		...
		$groups = KFactory::tmp($this->models->user_groups)->limit(0)->getList();
		...
		{
			$html[] = '	<tr class="'.KFactory::get('admin::com.ninja.helper.grid')->zebra().'">';
