 ...
 *
 * $Id: imagemagick.php 1399 2011-11-01 14:22:48Z stian $
 *
 * @package    Image
 * @author     Kohana Team
 ...
 */
class NinjaHelperImageDriverImagemagick extends NinjaHelperImageDriver {
	...
	public function flip($dir)
	{
		...
		$dir = ($dir === NinjaHelperImage::HORIZONTAL) ? '-flop' : '-flip';
	...
	public function resize($prop)
	{
		switch ($prop['master'])
		{
			case NinjaHelperImage::WIDTH:  // Wx
				$dim = escapeshellarg($prop['width'].'x');
			break;
			case NinjaHelperImage::HEIGHT: // xH
				$dim = escapeshellarg('x'.$prop['height']);
			break;
			case NinjaHelperImage::AUTO:   // WxH
				$dim = escapeshellarg($prop['width'].'x'.$prop['height']);
			break;
			case NinjaHelperImage::NONE:   // WxH!
				$dim = escapeshellarg($prop['width'].'x'.$prop['height'].'!');
			break;
		}
