...
var KTabs = new Class({
    ...
    options: {
        ...
        onActive: function(title, description){
            description.show();
            title.swapClass('closed', 'open');
        },

        onBackground: function(title, description){
            description.hide();
            title.swapClass('open', 'closed');
        }
    },
    ...
    initialize: function(dlist, options)
    {
		...
		if(this.options.cookies) {
			if(Cookie.read('ktabs.' + dlist)) this.options.display = Cookie.read('ktabs.' + dlist);
		}
    ...
    display: function(i)
    {
    	if (this.options.cookies) Cookie.write('ktabs.' + this.dlist.get('id'), i);
