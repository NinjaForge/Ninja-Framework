// Depencies from MooTools More, 1.3 version

// MooTools: the javascript framework.
// Load this file's selection again by visiting: http://mootools.net/more/dccb3284f9c8a0d2867b2435784358b1 
// Or build this file again with packager using: packager build More/Chain.Wait More/Array.Extras More/Date.Extras More/Number.Format More/String.Extras More/URI.Relative More/Hash.Extras More/Element.Delegation More/Element.Measure More/Element.Pin More/Fx.Accordion More/Fx.Move More/Fx.Reveal More/Fx.Slide More/Fx.SmoothScroll More/Fx.Sort More/Slider More/Sortables More/Request.Queue More/Request.Periodical More/Assets More/Group More/Hash.Cookie More/Scroller More/Tips More/Spinner
/*
---
copyrights:
...
},cleanValues:function(a){return new Hash(Object.cleanValues(this,a));},run:function(){Object.run(arguments);}});Events.Pseudos=function(g,c,e){var b="monitorEvents:";
...
b.inject(this.container);}}return this.parent.apply(this,arguments);}});(function(b){var a=Element.Position={options:{relativeTo:document.body,position:{x:"center",y:"center"},offset:{x:0,y:0}},getOptions:function(d,c){c=Object.merge({},a.options,c);
